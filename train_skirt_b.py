...
#----------------------------------------------------------------------------
# lisi stylegan, Borrow from Official training configs for StyleGAN, targeted mainly for FFHQ.
...
if 1:
    ...
    desc += '-skirtb512';  dataset = EasyDict(tfrecord_dir='skirt_paired_B_tf', resolution=512); train.mirror_augment = True
